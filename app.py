...
# --- 2. PERSISTENT LEFT SIDEBAR PANEL (WITH LOW-PRIORITY ADJUSTMENTS) ---
with st.sidebar:
    ...
    # Low Priority Filters / Fine-Tuning
...
def load_and_compute_gex_engine(ticker, r_rate, current_price, min_d, max_d):
    try:
        ...
        for exp_str in expirations:
            try:
                ...
                # Utilizing custom DTE bounds settings
...
if data_matrix is not None:
    ...
    fig.add_trace(go.Scatter(
        x=df_sorted_display['strike'], 
        y=df_sorted_display['cum_GEX_display'],
